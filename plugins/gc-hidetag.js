...
**/
    ...
    const htextos = `${text ? text : '𝚈𝚊𝚕𝚕𝚒𝚌𝚘 𝙱𝚘𝚝 🇦🇱'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://instagram.com/yallico.owner'}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|n|notificar|notify|aviso|noti)$/i;
handler.group = true;
handler.admin = true;
