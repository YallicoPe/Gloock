...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE Glocck 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR Glocck 🐈`}
...
//main.js
const smsWelcome = () => { return `*╭━〔 Glocck Bot 🇦🇱 〕━⬣*\n*┃ Bienvenido Al Mejor Grupo De WhatsApp 👤*\n*┃ Nombre :* @subject\n*┃ Usuario Nuevo :* @user\n*╰━━━━━━━━━━━━⬣*`}
const smsBye = () => { return '*╭━〔 Glocck Bot 🇦🇱 〕━⬣*\n*┃ Un Putita Menos En El Grupo 👤*\n*┃ Usuario :* @user\n*╰━━━━━━━━━━━━⬣*'}
...
//_allantilink.js
const smsTextoYT = () => { return '𝚈𝚊𝚕𝚕𝚒𝚌𝚘 𝙱𝚘𝚝 🇦🇱'} 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar Glocck`}
...
const smsContacto4 = () => { return 'Contacto Oficial de Glocck 🐈'}
